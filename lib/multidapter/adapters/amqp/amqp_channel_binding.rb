...
module Multidapter
  module AsyncApi
    class AmqpChannelBinding < Dry::Struct
      ...
      attribute :is,              Types::AmqpChannelType

      # The version of this binding. If omitted, "latest" MUST be assumed
      attribute :binding_version, Types::String

      # When is=routingKey, this object defines the exchange properties
      attribute :exchange, Types::Hash.meta(omittable: true) do
        ...
        attribute :type,        Types::AmqpExchangeType
      ...
      attribute :queue, Types::Hash.meta(omittable: true) do
