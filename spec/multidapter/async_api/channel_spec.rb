  ...
  context "Given valid required parameters" do
    ...
    context "with a Channel only" do
      ...
      it "should create new Channel instance" do
        expect(described_class.new(required_params)).to be_a Multidapter::AsyncApi::Channel
    ...
    context "with a Channel and ChannelItem" do
      ...
      it "should create new Channel instance" do
        expect(described_class.new(all_params)).to be_a Multidapter::AsyncApi::Channel
